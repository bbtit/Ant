...
if __name__ == "__main__":
  ...
  # 5×5のネットワークを生成
  # 1行目
  node_list.append(Node(np.array([[1,M,100],[5,M,50]])))
  ...
  # 2行目
  node_list.append(Node(np.array([[0,M,10],[6,M,50],[10,M,10]])))
  node_list.append(Node(np.array([[1,M,10],[5,M,10],[7,M,100],[11,M,50]])))
  ...
  node_list.append(Node(np.array([[6,M,10],[10,M,10],[12,M,50],[16,M,10]])))
  node_list.append(Node(np.array([[7,M,10],[11,M,10],[13,M,100],[17,M,50]])))
  ...
  node_list.append(Node(np.array([[12,M,10],[16,M,10],[18,M,50],[22,M,10]])))
  node_list.append(Node(np.array([[13,M,10],[17,M,10],[19,M,100],[23,M,50]])))
  ...
  node_list.append(Node(np.array([[18,M,10],[22,M,10],[24,M,50]])))
