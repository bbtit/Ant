...
if __name__ == "__main__":
  ...
  for _ in range(100):
    ...
    # 4行目
    node_list.append(Node(np.array([[10,M,10],[16,M,10],[20,M,10]]))) #15
    ...
    node_list.append(Node(np.array([[14,M,10],[18,M,10],[24,M,100]]))) #19
    # 5行目
    node_list.append(Node(np.array([[15,M,10],[21,M,10]]))) #20
    node_list.append(Node(np.array([[16,M,10],[20,M,10],[22,M,10]]))) #21
    node_list.append(Node(np.array([[17,M,10],[21,M,10],[23,M,10]]))) #22
    node_list.append(Node(np.array([[18,M,10],[22,M,10],[24,M,10]]))) #23
    node_list.append(Node(np.array([[19,M,10],[23,M,10]]))) #24
    ...
    for gen in range(GENERATION):
      ...
      for _ in range(ANT_NUM):
        ant_list.append(Ant(START_NODE,GOAL_NODE,[START_NODE],W))
